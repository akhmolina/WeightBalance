...
public class Subset implements Cloneable {
	...
	public Subset(int[] Set, BitSet SubsetFilling) throws IllegalArgumentException
	{
		...
		{throw new IllegalArgumentException("–азмеры массива последовательности должен быть "
				+ "не меньше размера массива производ€щей функции.");}	
		if (Set.length <1)
		{throw new IllegalArgumentException("–азмер последовательности должен быть больше 0.");}
	...
	{
		if (position< 0 || position > Set.length-1){throw new IllegalArgumentException("ѕозици€ дл€ включени€ "
